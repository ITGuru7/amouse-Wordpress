	...
	class Theshopier_Ajax {
		...
		public static function woo_getproductinfo(){
			...
			while ( $products->have_posts() ) : $products->the_post(); global $product;
				...
				printf( '<div class="nth_add_to_cart_product_info"><a href="%s" title="%s">%s<span class="product-title">%s</span></a>%s</div>', esc_url( $product->get_permalink() ), esc_attr( $product->get_title() ), $product->get_image(), $product->get_title(), $product->get_price_html() );
